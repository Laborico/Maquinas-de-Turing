Public Class PredecesorUnario
    ...
    Private Sub PredecesorUnario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Sub s2()
        res = entrada.Substring(0, entrada.Length - 2)
        TBRes.Text = res
    End Sub
