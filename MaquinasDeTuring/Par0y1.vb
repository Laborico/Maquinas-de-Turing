Public Class Par0y1
    ...
    Private Sub Par0y1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Par0y1_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Carga.Close()
    End Sub
