Public Class Binario
    ...
    Private Sub Binario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Binario_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Carga.Close()
    End Sub
    ...
    Sub ms3()
        If res(cont) = "0" Or res(cont) = "1" Then
            cambio()
            cont -= 1
            LAnt.Text = em
            em = "S3"
