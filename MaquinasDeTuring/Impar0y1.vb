Public Class Impar0y1
    ...
    Private Sub Impar0y1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Impar0y1_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Carga.Close()
    End Sub
